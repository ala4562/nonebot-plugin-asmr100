...
### v0.3.2 - 调度与发布优化
**🔧 逻辑优化**
- 提升缓存清理调度器的稳定性，支持优雅取消并避免重复启动
- 启动与关闭阶段增加更清晰的日志提示，便于排查任务状态

**📚 文档更新**
- 补充 PyPI 发布教程与命令示例，便于快速推送新版本
- 新增版本变更说明，便于了解升级内容
...
3. 上传到 PyPI（需要在环境中配置好 PyPI 访问令牌）
   ```bash
...
4. 验证安装
   ```bash
   pip install --upgrade nonebot-plugin-asmr100
   ```
- 支持文件转换和压缩
- 基础的用户交互界面
